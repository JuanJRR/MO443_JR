...
from activity_001.src.analysis import (
...
from activity_001.utilities.logging_settings import logging_settings
...
image_paths = {
    ...
    "house": "data/house.png",
    "monalisa": "data/monalisa.png",
    "peppers": "data/peppers.png",
    "seagull": "data/seagull.png",
}
...
imagen_filtering_analysis(path=image_paths["watch"])
